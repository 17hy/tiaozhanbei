...
def parse_arg():
    if len(sys.argv) < 3:
        ...
        print("       model_path: .onnx or .torchscript file")
        ...
        print("       Example: python3 pt2rknn.py best.onnx rk3588 i8")
        print("       Example: python3 pt2rknn.py best.torchscript rk3588 i8")
        exit(1)
...
if __name__ == '__main__':
    ...
    if model_path.endswith('.onnx'):
        ...
        print('Unsupported model format. Please use .onnx or .torchscript files.')
        exit(1)
    if ret != 0:
